  ...
  return (
    <main className="flex min-h-screen flex-col items-center justify-top p-24">
...

      {
       session?.user ?
       <>
        <h1 className={`mb-3 text-2xl font-semibold mb-10`}>
          Portal de Administradores
        </h1>
        <h2 className={`mb-3 text-xl mb-10`}>
          Hola, {session?.user?.name + "!"}
        </h2>
       <Grid numItems={2} className="mb-32 grid text-center lg:max-w-5xl lg:w-full lg:mb-0 lg:grid-cols-2 lg:text-left gap-3">
        <Card className='transition-colors hover:border-gray-50 hover:bg-gray-100 hover:dark:border-neutral-700 hover:dark:bg-neutral-200/30'>
          <a
            href="/events/new"
